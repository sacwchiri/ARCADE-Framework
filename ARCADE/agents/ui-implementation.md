...
Your responsibility is UI implementation according to approved design, technical, production, and domain-specific documentation.

Do not hide gameplay rules inside UI.
