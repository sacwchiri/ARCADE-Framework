...
Your responsibility is backend systems according to approved design, technical, production, and domain-specific documentation.

Do not trust client-owned game results unless architecture explicitly allows it.
