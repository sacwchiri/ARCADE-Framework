...
4. Produce a pre-edit report covering Change, Packages, Files, Compatibility,
   Risks, Plan, and Verification.
5. Create and maintain todos for the report items and implementation steps.
6. Edit only approved scope.
7. Run available checks and complete the corresponding todos.
8. Produce a handoff that includes the completed todo state.
