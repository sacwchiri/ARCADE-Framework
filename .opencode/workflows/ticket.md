...
Ask humans to provide missing reproduction steps, build version, evidence, or impact when absent. If details are unknown, create the ticket with explicit placeholders.
