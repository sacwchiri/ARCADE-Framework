...
Review the result and answer concrete questions such as:
...
The human does not need to edit every document manually. They approve, reject, or correct decisions. The agents then update the documents.
